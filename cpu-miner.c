...
static bool submit_upstream_work(CURL *curl, struct work *work)
{
	...
	if (have_stratum) {
		...
		//if (opt_algo==ALGO_SIF)
		//sprintf(s,
		//	"{\"method\": \"getwork2\", \"params\": [ \"%s\" ], \"id\":1}\r\n",
		//	str);
		//else
		sprintf(s,
...
static bool get_upstream_work(CURL *curl, struct work *work)
{
	...
	/// ---- sif
	//if (opt_algo==ALGO_SIF)
	//val = json_rpc_call(curl, rpc_url, rpc_userpass, rpc_req2,
...
start:
	...
	while (1) {
		...
		/// ---sif getwork2
        //if (opt_algo==ALGO_SIF)
		//val = json_rpc_call(curl, lp_url, rpc_userpass, rpc_req2,
		//		    false, true, &err);
		//else
...
int main(int argc, char *argv[])
{
	...
	printf("\xC9\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xCD\xBB\n");
	printf("\xBA  Q2C cpu-miner (v1.2)                              \xBA\n");
	printf("\xBA  author: elmad (forked from ig0tik3d 1.1a version) \xBA\n");
	printf("\xBA  http://www.q2c.cc                                 \xBA\n");
