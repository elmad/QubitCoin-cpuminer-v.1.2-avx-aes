...
#pragma unroll for (i=0;i<8;i++) 
	...
	STEP_PART2(chainv[8],chainv[9],t[0],t[1],CNS128[16+6],CNS128[17+6],tmp[0],tmp[1]); \
	STEP_PART2(chainv[8],chainv[9],t[0],t[1],CNS128[16+8],CNS128[17+8],tmp[0],tmp[1]); \
	STEP_PART2(chainv[8],chainv[9],t[0],t[1],CNS128[16+10],CNS128[17+10],tmp[0],tmp[1]); \
